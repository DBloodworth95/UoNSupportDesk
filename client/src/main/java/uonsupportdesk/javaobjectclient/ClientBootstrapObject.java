...
import uonsupportdesk.protoclient.ClientInitializerProto;

import java.util.ArrayList;
import java.util.List;
import java.util.logging.Logger;

public class ClientBootstrapObject {
    ...
    private final ClientInitializerObject clientInitializer = new ClientInitializerObject();
